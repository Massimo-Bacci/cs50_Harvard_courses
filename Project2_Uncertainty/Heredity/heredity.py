...
# def calculate_gene_number(person, one_gene, two_genes):
#         return 1 if person in one_gene else 2 if person in two_genes else 0

# def calculate_trait(person, have_trait):
#     return person in have_trait

# def calculate_gene_probability(gene_number, mother_gene_number):
#     if gene_number == 0:
#         return 1 - PROBS['mutation']
#     elif gene_number == 1:
#         return (1 - PROBS['mutation']) * 0.5 + PROBS['mutation'] * 0.5
#     else:
#         return PROBS['mutation'] * 0.5 + (1 - PROBS['mutation']) * PROBS['gene'][mother_gene_number]
